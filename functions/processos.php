        ...
        if(mysqli_query($conn, $update_query)) {
            ...
            if(isset($_POST['responsavel'])){
                for($count = 0; $count < sizeof($_POST['responsavel']); $count++){
                    ...
                    $query_responsaveis_test = "SELECT * FROM responsavel_by_processos WHERE pid = ".$_POST['id']." AND position = ".$count." AND responsavel = '".$_POST['responsavel'][$count]."'";

                    $query_responsaveis_new = "SELECT * FROM responsavel_by_processos WHERE pid = ".$_POST['id']." AND position = ".$count." AND responsavel = '".$_POST['responsavel'][$count]."'";
                    
                    if(!empty($_POST['responsavel'][$count])){
                        print_r(mysqli_query($conn, $query_responsaveis_test)->num_rows);
